...
class ProjectEstimantion extends Model{
     ...
     * @return response()
     */
    protected $fillable = ['user_id', 'project_name', 'project_location', 'code_of_design', 'type_of_frame', 'wind_speed', 'span', 'width', 'height', 'length_of_building', 'main_frame_steel_m2', 'main_frame_steel_kg', 'top_purlin_m2', 'top_purlin_kg', 'side_wall_girt_m2', 'side_wall_girt_kg', 'gable_end_girt_m2', 'gable_end_girt_kg', 'roofing_sheet_m2', 'roofing_sheet_kg', 'clading_sheet_m2', 'clading_sheet_kg', 'sag_rod_m2', 'sag_rod_kg', 'stay_brace_m2', 'stay_brace_kg', 'anchor_bolt_m2', 'anchor_bolt_kg', 'cleat_m2', 'cleat_kg', 'x_bracing_m2', 'x_bracing_kg', 'finishing_m2', 'finishing_kg', 'total_quantity_m2', 'atotal_quantity_kg'];
